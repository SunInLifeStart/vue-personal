...
export default {
	...
	emoji: function(text) {
		...
		if (supportEmoji) {
			...
			// this.emoji(text);
			 return '<img  class="emoji" style="vertical-align:middle;width:24px" src="' + $self.emojiPath + $self._escapeToUtf32(text) + '.png">';
	// 	});
		}
	},
	...
	// 	fontSize += 4;
	// 	fontSize = Math.min(fontSize, this.maxSize);
	// 	let $self = this;
	// 	text = text.replace(this.reg, function(code) {
	// 		return '<img width=' + fontSize + ' class="emoji" style="vertical-align:middle" src="' + $self.emojiPath + $self._escapeToUtf32(code) + '.png">';
	// 	});

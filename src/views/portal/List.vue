                ...
                <li v-for="item of list" :key="item.articleId">
                   ...
                   <div style="flex:30" v-if="type != 'yq'">
                    ...
                    <div style="flex:2" v-if="type == 'yq'">
                         <a :href="item.url" target="_blank"> <el-button size="mini">详情</el-button></a>
                   </div>
                   <div style="flex:2" v-if="type != 'yq'">
                         <router-link :to="'/portal/list/'+type+'/' +params.page+ '/' + item.articleId"><el-button size="mini">详情</el-button></router-link>
                   </div>
                </li>
            </ul>
...
export default {
    ...
    methods: {
        changeType(){
            this.showSquTips = this.showSquTips == '展示列表' ? "展示图表" : "展示列表";
        },

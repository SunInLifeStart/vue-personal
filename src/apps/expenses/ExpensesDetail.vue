        ...
        <div class="formContent">
            ...
            <el-form :model='tableData' class="formList">
                <el-row>
                    ...
                    <el-col :span="8">
                        <el-form-item label="申请时间：">{{tableData.committed}}
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="接待部门：">{{tableData.trainingPrograms}}
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="接待时间：">{{tableData.startTime}}
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="公司参加陪同人员：">{{tableData.phone}}
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="客户来访人员及职务：">{{typeJuder}}
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="是否标准内：">{{isAnnualPlanone}}
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="预计金额：">{{tableData.upper}}
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="招待事由：">{{tableData.trainingContent}}
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="招待地点：">{{tableData.participant}}
                        </el-form-item>
                    </el-col>
                     <el-col :span="12">
                        <el-form-item label="客户单位：">{{tableData.participant}}
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="预计人数：">{{tableData.schedule}}
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>

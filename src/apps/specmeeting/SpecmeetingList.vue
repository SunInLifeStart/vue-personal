...
export default {
    ...
    methods: {
        getList() {
            ...
            axios
                .post(
                    '/api/v1/spec_meeting_forms/query',
        ...
        deleteItem(row) {
            ...
            this.$confirm('是否删除?', '提示', { type: 'warning' }).then(() => {
                axios
                    .get('/api/v1/spec_meeting_forms/delete/' + row.id)
                    .then(res => {
                        self.$message({
                            message: '删除成功',
                            type: 'success'

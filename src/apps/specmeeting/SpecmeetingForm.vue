<template>
    <div id="SpecMeetingForm">
        <el-form :model="rows" label-width="100px" :rules="rules" ref="formupdate">
            <el-row>
                <el-col :span="8">
                    <el-form-item label="专题会编号" prop="numbers">
                        <el-input v-model="rows.numbers" placeholder="请输入专题会编号"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
            ...
            <el-row>
                <el-col :span="24">
                    <el-form-item label="正文" prop="content">
                        <el-input v-model="rows.content" :autosize="{ minRows: 2, maxRows: 20}" placeholder="请输入正文" type="textarea" :rows="3"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
            ...
            <el-row>
                <el-col :span="24">
                    <el-col :span="24">
                        <el-col :span="24">
                            <el-form-item label="参会人员" prop="delegate">
                                <el-select style="width:100%;" v-model="rows.delegate" multiple filterable readonly default-first-option placeholder="请选择参会人员">
                    ...
                    <el-col :span="24">
                        <el-col :span="24">
                            <el-form-item label="记录" prop="writer">
                                <el-select style="width:100%;" v-model="rows.writer" filterable readonly default-first-option placeholder="请选择记录人">
                                    <el-option v-for="item in users" :key="item.id" :label="item.name" :value="item.name">
                                    </el-option>
                                </el-select>
                            </el-form-item>
...
export default {
    ...
    methods: {
        getId(id) {
            ...
            self.$confirm('是否删除?', '提示', { type: 'warning' }).then(() => {
                self.rows.attachments.forEach(function(value, index) {
                    if (value.id == id) {
                        axios
                            .get('/api/v1/spec_meeting_forms/deleteAtt/' + id)
                            .then(res => {
        ...
        saveForm(action = '') {
            ...
            axios
                .post(
                    '/api/v1/spec_meeting_forms/save',
        ...
        submitForm() {
            ...
            axios
                .post(
                    '/api/v1/spec_meetings/' + this.currentFormId + '/create',
                    '',
                    {
                        headers: {
                            'Content-type': 'application/json'
        ...
        comment() {
            ...
            axios
                .put(
                    `/api/v1/spec_meeting_forms/${self.currentFormId}/comment`,
                    {
                        content: '提交',
                        action: 'COMMIT',
                        node: '提交'
        ...
        startProcess() {
            ...
            axios
                .put(
                    '/api/v1/spec_meetings/' + this.currentFormId + '/signal',

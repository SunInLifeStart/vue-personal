                ...
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="领用时间" prop="recipientsTime">
                            <el-date-picker v-model="formData.recipientsTime" @change="getHour(formData.recipientsTime,formData.endTime)" value-format="yyyy-MM-dd HH:mm:ss" type="datetime" placeholder="领用时间">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="结束时间" prop="endTime">
                            <el-date-picker v-model="formData.endTime" @change="getHour(formData.recipientsTime,formData.endTime)" value-format="yyyy-MM-dd HH:mm:ss" type="datetime" placeholder="结束时间">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                ...
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="用印明细">
                            ...
                            <el-table :data="formData.usingApproval" border style="width: 100%; margin-top: 5px;color:black" @selection-change="handleSelectionChange" :row-class-name="tableRowClassName" @row-click='show'>
                    ...
                    .then(() => {
                        self.selectionItems.forEach(function(oData) {
                            ...
                            axios
                                ...
                                .then(res => {
                                    self.formData.usingApproval.forEach(
                                        function(item, index) {

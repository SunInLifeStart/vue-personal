...
export default {
    ...
    methods: {
        getList() {
            const self = this;
            const params = {
                startYear: this.searchOptions.startYear
                    ? this.searchOptions.startYear
                    : '',
                endYear: this.searchOptions.endYear
                    ? this.searchOptions.endYear
                    : '',
                groupName: this.searchOptions.groupName
                    ? this.searchOptions.groupName
                    : ''
            };
            axios
                .post(
                    '/budget/executionPlan/budgetGroupQuery',

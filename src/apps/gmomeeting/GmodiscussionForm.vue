                ...
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="内容">
                            <el-input type="textarea" :rows="2" :autosize="{ minRows: 2, maxRows: 20}" placeholder="请输入内容" v-model="formData.content">
                            </el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="序号">
                            <el-input :rows="2" v-model="formData.serial" :disabled="true">
                            </el-input>
                        </el-form-item>
                    </el-col>
                </el-row>

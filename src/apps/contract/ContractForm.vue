            ...
            <el-form :model="formData" label-width="100px" :rules="rules" ref="formupdate">
                ...
                <table style="width: 99%; height: 100%;margin-top: 5px; table-layout: fixed; word-break: break-all;">
                    ...
                    <tr>
                        <td colspan="2">
                            合同附件
                            <el-upload name="files" class="upload" ref="upload" action="/api/v1/files/upload" @click.native="clickAttach('attType1')" :on-success="handleSuccess" :multiple="true" :with-credentials="true" :show-file-list="false">
                            ...
                            <el-row style="padding:5px">
                                <el-col :span="14">
                                    <div style="float:left">
                                        谈判小组成员（不同部门2人或以上）签字：
                                        <el-select v-model="formData.tpxzId" @change="changePeople" value-key="id" multiple filterable placeholder="请选择" :disabled="this.showSubmit == 'false'">

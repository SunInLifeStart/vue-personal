...
export default {
    ...
    methods: {
        ...
        getActions() {
            ...
            axios.get('/api/v1/gmo_meeting_forms/' + param + '/actions').then(res => {
                this.actions = res.data.types;
            });
            axios.get(`/api/v1/gmo_meeting_forms/${this.formId}/crumb`).then(res => {
        ...
        doComment(action) {
            ...
            axios
                .put(`/api/v1/gmo_meeting_forms/${this.formId}/comment`, {
                    content: comment
                })
                .then(res => {
                    comment = '';
                    ...
                    this.getForm();
                    //分配，前加签，后加签启动流程
                    if ('ASSIGN,PRESIGN,POSTSIGN'.includes(action.type)) {
                        axios

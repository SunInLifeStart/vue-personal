...
export default {
    ...
    methods: {
        ...
        async saveIncomingApply() {
            const $self = this;
            if ($self.tableData.type == '事假') {
                $self.tableData.type = 1;
            } else if ($self.tableData.type == '病假') {
                $self.tableData.type = 2;
            } else if ($self.tableData.type == '婚假') {
                $self.tableData.type = 3;
            } else if ($self.tableData.type == '产假') {
                $self.tableData.type = 4;
            } else if ($self.tableData.type == '丧假') {
                $self.tableData.type = 5;
            } else if ($self.tableData.type == '工伤假') {
                $self.tableData.type = 6;
            } else if ($self.tableData.type == '年休假') {
                $self.tableData.type = 7;
            } else if ($self.tableData.type == '其他') {
                $self.tableData.type = 8;
            }

<template>
    <el-card id="RegulationsList">
        <div slot="header" class="clearfix">
            <h4>法规制度</h4>
            <el-button class="new-notice" type="primary" @click="dialogFormVisible = true; operationType = 'create'">草拟法规制度</el-button>
        </div>
        <el-table :data="tableDraftData" :model="params">
            ...
            <el-table-column prop="title" label="标题" align="center">
                <template slot-scope="scope">
                    <p @click="openDraftPage('view', scope.row)">{{scope.row.title}}</p>
                </template>
            </el-table-column>
            ...
            <el-table-column label="操作" align="center" fixed="right" width="170px">
                <template slot-scope="scope">
                    <el-button type="primary" size="mini" circle title="编辑" icon="el-icon-edit" @click="openDraftPage('edit', scope.row)"></el-button>
                    <el-button type="primary" size="mini" circle title="审批" @click="viewItem('view', scope.row)">审</el-button>
                    <el-button type="danger" size="mini" circle title="删除" icon="el-icon-delete" @click="deleteItem(scope.$index, scope.row.id)"></el-button>
                </template>
            </el-table-column>
        </el-table>
        <el-dialog title="草拟法规制度" :visible.sync="dialogFormVisible" max-width="1280px" width="70%">
                ...
                <el-form ref="rows" :model="rows" label-width="120px">
                    ...
                    <div style="margin-top:5px;">
                        <el-tabs v-model="activeName">
                            <el-tab-pane label="法规制度" name="tzgg" v-model="rows">

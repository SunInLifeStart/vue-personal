<template>
    <div id="Special" class="main-container">
        ...
        <el-dialog title="下发文件" :visible.sync="dialogFormVisible" max-width="1280px" width="70%" :close-on-click-modal="false">
            <SpecialForm ref="specialform" @info="getInfo" @refreshData="refreshData" :formId="dialogFormId" :operationType="operationType"></SpecialForm>
...
export default {
    ...
    methods: {
        ...
        saveForm() {
            this.$refs.specialform.saveForm();
            this.dialogFormVisible = false;
        },
        submitForm() {

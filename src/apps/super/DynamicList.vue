<template>
    <el-card id="DynamicList">
        <div slot="header" class="clearfix">
            <h4>工作动态</h4>
            <el-button class="new-notice" type="primary" @click="dialogFormVisible = true; operationType = 'create'">草拟工作动态</el-button>
        </div>
        ...
        <el-dialog title="草拟工作动态" :visible.sync="dialogFormVisible" max-width="1280px" width="70%">
                ...
                <el-form ref="rows" :model="rows" label-width="120px">
                    ...
                    <div style="margin-top:5px;">
                        <el-tabs v-model="activeName">
                            <el-tab-pane label="工作动态" name="tzgg" v-model="rows">

            ...
            <el-form :model='formData' ref="formData">
                ...
                <table style="width: 99%; height: 100%;margin-top: 5px; table-layout: fixed; word-break: break-all;">
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            <el-input type="textarea" v-model="formData.paymentExplain" :autosize="{minRows: 5}"></el-input>
                        </td>
                        <td>
                            费用归属项目
                        </td>
                        <td colspan="2">
                            <el-input type="textarea" v-model="formData.project" :autosize="{minRows: 5}"></el-input>
                        </td>
                    </tr>
                    <tr class="fontBold">
                        <td colspan="2">
...
export default {
    ...
    methods: {
        ...
        getTravelList() {
            ...
            if (cookies.get('uid') != '') {
                axios
                    .get('/api/v1/expense_forms/getTravels')
                    .then(res => {

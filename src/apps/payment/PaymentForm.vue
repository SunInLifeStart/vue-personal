            ...
            <el-form :model='formData' ref="formData">
                ...
                <table style="width: 99%; height: 100%;margin-top: 5px; table-layout: fixed; word-break: break-all;">
                    ...
                    <tr>
                        ...
                        <td colspan="7">
                            <el-input type="textarea" v-model="formData.paymentExplain" :autosize="{minRows: 10}"></el-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td colspan="7">
                            <el-input type="textarea" v-model="formData.project" :autosize="{minRows: 3}"></el-input>
                        </td>
                    </tr>
                    <tr class="fontBold">
                        <td colspan="2">
                    ...
                    <tr class="fontBold">
                        ...
                        <td rowspan="3">
                            ...
                            -->
                            <format-input v-if="this.moneyType=='1'" separator="," :precision="2" class="money" v-model="formData.contract.amount" :max="1000000000000" :min="-10000000" empty-value="0" :minus="true" @input="getAmount('contractDetail')" />
                            <format-input v-else separator="," :precision="2" class="money" v-model="formData.contract.amount" :max="1000000000000" :min="-10000000" empty-value="0" :minus="true" />
                        </td>
                        <td rowspan="3">
                            前期已付
                        </td>
                        ...
                        <td>
                            <format-input v-if="this.moneyType=='1'" separator="," :precision="2" class="money" v-model="formData.contract.payments" :max="1000000000000" :min="-10000000" empty-value="0" :minus="true" @input="getAmount('contractDetail')" />
                            <format-input v-else class="money" separator="," :precision="2" v-model="formData.contract.payments" :max="1000000000000" :min="-10000000" empty-value="0" :minus="true" />
                        </td>
                        <td rowspan="3">
                            <span class="span">*</span>
                            未付金额
                        ...
                        <td colspan="2" rowspan="3">
                            ...
                            <format-input v-else class="money" separator="," :precision="2" v-model="formData.contract.unAmount" :max="1000000000000" :min="-10000000" empty-value="0" :minus="true" />
                        </td>
                    </tr>
                    <tr class="fontBold">
                        <td>
                        ...
                        <td>
                            ...
                            <format-input v-else class="money" separator="," :precision="2" @input="getReal()" v-model="formData.contract.cumulativePro" :max="1000000000000" :min="-10000000" empty-value="0" :minus="true" />
                        </td>
                    </tr>
                    <tr class="fontBold">
                        <td>
                        ...
                        <td>
                            ...
                            <format-input v-else class="money" separator="," :precision="2" @input="getReal()" v-model="formData.contract.cumulativeAfter" :max="1000000000000" :min="-10000000" empty-value="0" :minus="true" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" class="fontBold">
                            <el-upload name="files" ref="upload" action="/api/v1/files/upload" :on-success="handleSuccess" :multiple="true" :auto-upload="true" :with-credentials="true" :show-file-list="false">
                                <span class="span">*</span>

    ...
    <div id="nmployeesForm">
        ...
        <el-form :model="rows" label-width="100px" :rules="rules" ref="formupdate">
           <el-row style="float:left;margin-botton:20px">
            ...
            <el-row >
                <el-col :span="24">
                   <!-- <span style="text-align:center;font-weight:bold;font-size:19px;">基本信息</span> -->
                </el-col>
            </el-row>
            <el-row >
                <el-col :span="8">
             ...
             <!-- <el-row >
                <el-col :span="24">
                   <span style="text-align:center;font-weight:bold;font-size:19px;">员工基本信息</span>
                </el-col>
            </el-row> -->
            <el-row >
                <el-col :span="6">
                    <el-form-item label="姓名" style="float:left">
                       <el-input v-model="rows.names" placeholder="请输入姓名" ></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="6">
                    <el-form-item label="性别"  style="float:left">
                       <el-input v-model="rows.sex" placeholder="请输入性别" ></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="6">
                    <el-form-item label="出生日期" style="float:left">
                       <el-input v-model="rows.birthday" placeholder="请输入出生日期" ></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="6">
                    <el-form-item label="学历"  style="float:left">
                       <el-input v-model="rows.education" placeholder="请输入学历" ></el-input>
                    </el-form-item>
                </el-col>
                <!-- <el-col :span="8">
            ...
            <el-row >
                <el-col :span="8">
                    <el-form-item label="参加工作时间"  style="float:left">
                       <el-input v-model="rows.worktime" placeholder="请输入参加工作时间" ></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="入职时间"  style="float:left">
                       <el-input v-model="rows.toworktime" placeholder="请输入入职时间" ></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="职称"  style="float:left">
                       <el-input v-model="rows.titlename" placeholder="请输入职称" ></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row >
             ...
             <el-row>
                <el-col :span="24">
                    <el-form-item label="转正总结" >
                        <el-input type="text" v-model="rows.correction" placeholder="请输入转正总结"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>

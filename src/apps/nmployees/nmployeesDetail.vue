<template>
    <div id="nmployeesDetail" :class="{fullScreen:fullScreen}">
        ...
        <div class="formContent">
            <el-form :model='tabledata' class="formList">
                ...
                <el-row>
                    ...
                    <el-col :span="8">
                        <el-form-item label="申请时间：">{{tabledata.drafter}}
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="姓名：">{{tabledata.names}}
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                ...
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="学历：">{{tabledata.education}}
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="参加工作时间：">{{tabledata.worktime}}
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>

    ...
    <div id="GovernmentForm">
        <el-form ref="formupdate" :model="selectItem" label-width="100px">
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item label="报道人:">
                        <el-input v-model="selectItem.creatorName" disabled="disabled"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
...
export default {
    ...
    methods: {
            ...
            if (this.selectItem.attachments.length > 0) {
                this.$confirm('是否删除?', '提示', { type: 'warning' }).then(
                    () => {
                        ...
                        axios
                            .get(
                                '/api/v1/activity_forms/affairs/deleteAtt' + id,
                                '',
                                {
                                    headers: {
        ...
        saveForm(action = '') {
            ...
            axios
                .post(
                    '/api/v1/activity_forms/affairs/save',

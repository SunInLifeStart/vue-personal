<template>
    <div id="GovernmentList">
        <el-table :data="tableData" stripe style="width: 100%" @row-click="clickTableRow">
            ...
            <el-table-column prop="title" label="刊物名称">
            </el-table-column>
            <el-table-column prop="date" label="报送日期">
            </el-table-column>
            <el-table-column prop="creatorName" label="报道人">
            </el-table-column>
            <el-table-column prop="organName" label="报道单位">
            </el-table-column>
...
export default {
    ...
    methods: {
        getList() {
            ...
            axios
                .post(
                    '/api/v1/activity_forms/affairs/query',
        ...
        deleteItem(row) {
            ...
            axios
                .get('/api/v1/activity_forms/affairs/delete/' + param, {
                    headers: {
                        'Content-type': 'application/json'
                    }
                })

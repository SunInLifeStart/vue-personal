<template>
    <div id="TrainDetail" :class="{fullScreen:fullScreen}">
        ...
        <div class="formContent">
            <el-form :model='tabledata' class="formList">
                ...
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="申请缘由：">{{tabledata.content}}
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="拟休假时间：">{{tabledata.draftTime}}
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="审批意见：">{{tabledata.suggestion}}
                        </el-form-item>
                    </el-col>
                </el-row>

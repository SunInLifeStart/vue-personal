            ...
            <el-row>
                <el-col :span="8">
                    <el-form-item label="会议地点">
                        <el-input v-model="rows.applyDepartment" placeholder="请输入会议地点"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                        ...
                        <el-form-item label="会议讨论事项" prop="content">
                            <tr v-for="(item,index) in rows.requestedItems" :key="index" @contextmenu.prevent="deleteItem(item,index,'personal')">
                                <td colspan="8" style="width: 20%;">
                                    <el-input v-model="item.content" placeholder="请输入讨论事项"></el-input>
                                </td>
                            </tr>
                            <tr>
...
<style scoped>
    ...
    #ApplyMettingForm >>> .el-form-item__content{

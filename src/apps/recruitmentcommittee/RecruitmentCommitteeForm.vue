<template>
    <el-dialog title="会议申请(招采委员会)" :visible.sync="dialogFormVisible" :close-on-click-modal="false" max-width="1280px" width="70%" style="text-align: center;">
...
<style scoped>
    ...
    #RecruitmentCommitteeForm >>> .el-form-item__content{

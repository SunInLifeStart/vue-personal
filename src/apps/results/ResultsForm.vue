                    ...
                    <el-col :span="24">
                        <el-form-item label="关联采购方案" prop="procschemeNo">
                            <el-select v-model="formData.procschemeNos" value-key="id" placeholder="请选择采购方案">
                                <el-option v-for="item in issueOption" :key="item.id" :label="item.number" :value="{id: item.id, number: item.number}">
                                </el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                    ...
                    <el-col :span="24">
                        <el-form-item label="关联招标文件" prop="biddocumentNo">
                            <el-select v-model="formData.biddocumentNos" value-key="id" placeholder="请选择招标文件">
                                <el-option v-for="item in biddocumentOption" :key="item.id" :label="item.number" :value="{id: item.id, number: item.number}">
                                </el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                ...
                <el-row>
                    ...
                    <el-col :span="8">
                        <el-form-item label="采购起止时间" prop="proTime">
                            <el-date-picker v-model="formData.proTime" type="daterange" range-separator="至" value-format="yyyy-MM-dd HH:mm:ss" start-placeholder="开始日期" end-placeholder="结束日期">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="采购报告(评标报告)的附审资料">
                            <el-upload name="files" class="upload-demo uploadBtn" ref="uploadRep" action="/api/v1/files/upload" :on-success="handleSuccessRep" :multiple="true" :show-file-list="false" accept="" :auto-upload="true" :with-credentials="true">
                                <i class="el-icon-plus"></i>
                            </el-upload>
            ...
            if (this.formId != '') {
                axios
                    ...
                    .then(res => {
                        ...
                        self.formData.proTime = [
                            self.formData.proTimeStart,
                            self.formData.proTimeEnd
                        ];
                    });
            }
        },

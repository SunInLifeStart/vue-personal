                    ...
                    <el-row class="filterForm">
                        ...
                        <el-col :span="8">
                            <el-form-item label="培训时间">
                                <el-date-picker v-model="params.trainingTime" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd HH:mm:ss" @change="time_change"></el-date-picker>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row class="filterForm">
